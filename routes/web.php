...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::get('/safety/p2h/monitoring', [P2HController::class, 'monitoring'])->name('monitoring.p2h')->middleware('checkRole'.':ADMIN');
    Route::get('/safety/p2h/api/monitoring', [P2HController::class, 'api_monitoring'])->name('p2h.api_monitoring')->middleware('checkRole'.':ADMIN');
    Route::get('/safety/p2h/detail_monitoring', [P2HController::class, 'detail_monitoring'])->name('p2h.detail_monitoring')->middleware('checkRole'.':ADMIN');
