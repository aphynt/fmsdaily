...
setTimeout(function () {
    for (var e = {
        ...
        }, a = new ApexCharts(document.querySelector("#line-chart-1"), e), t = (a.render(), 0), n = [], r = new Date("11 Feb 2017 GMT").getTime(), o = 10, i = {
            min: 10,
            max: 90
        }, s = 0; s < o;) {
        var m = r,
    ...
    var c = {
        ...
        e = (h.render(), window.setInterval(function () {
            var e, a;
            e = t, a = {
                min: 10,
                max: 90
            ...
            n = n.slice(n.length - 10, n.length), h.updateSeries([{
                data: n
            }], !1, !0)
        }, 6e4), new ApexCharts(document.querySelector("#line-chart-3"), {
            chart: {
                height: 300,
                type: "line",
                zoom: {
        ...
        }).render(), new ApexCharts(document.querySelector("#area-chart-1"), {
            chart: {
                height: 350,
                type: "area",
                toolbar: {
        ...
        c = ((a = new ApexCharts(document.querySelector("#area-chart-2"), e)).render(), document.querySelector("#one_month").addEventListener("click", function (e) {
            d(e), a.updateOptions({
                xaxis: {
        ...
        }), document.querySelector("#ytd").addEventListener("click", function () {}), new ApexCharts(document.querySelector("#bar-chart-1"), {
            chart: {
                height: 350,
                type: "bar"
            },
        ...
        }).render(), new ApexCharts(document.querySelector("#bar-chart-2"), {
            chart: {
                height: 350,
                type: "bar",
                stacked: !0,
            ...
            colors: ["#4680FF", "#2CA87F", "#E58A00", "#13c2c2"],
            responsive: [{
                breakpoint: 480,
                options: {
                    legend: {
        ...
        }).render(), new ApexCharts(document.querySelector("#bar-chart-3"), {
            chart: {
                height: 350,
                type: "bar"
            },
        ...
        }).render(), new ApexCharts(document.querySelector("#bar-chart-4"), {
            chart: {
                height: 350,
                type: "bar",
                stacked: !0,
        ...
        }).render(), new ApexCharts(document.querySelector("#mixed-chart-1"), {
            chart: {
                height: 350,
                type: "line"
            },
        ...
        }).render(), new ApexCharts(document.querySelector("#mixed-chart-2"), {
            chart: {
                height: 350,
                type: "line",
                stacked: !1
    ...
    new ApexCharts(document.querySelector("#candlestick-chart-1"), c).render(), e = {
        chart: {
            height: 350,
            type: "bubble"
        },
    ...
    }, new ApexCharts(document.querySelector("#bubble-chart-1"), e).render(), c = {
        chart: {
            height: 350,
            type: "bubble"
        },
    ...
    }, new ApexCharts(document.querySelector("#bubble-chart-2"), c).render(), e = {
        chart: {
            height: 350,
            type: "scatter",
            zoom: {
    ...
    }, new ApexCharts(document.querySelector("#scatter-chart-1"), e).render(), c = {
        chart: {
            height: 350,
            type: "scatter",
            zoom: {
    ...
    }, new ApexCharts(document.querySelector("#scatter-chart-2"), c).render(), e = {
        chart: {
            height: 350,
            type: "heatmap"
        },
    ...
    }, new ApexCharts(document.querySelector("#heatmap-chart-1"), e).render(), c = {
        chart: {
            height: 350,
            type: "heatmap"
        },
    ...
    }, new ApexCharts(document.querySelector("#heatmap-chart-2"), c).render(), new ApexCharts(document.querySelector("#pie-chart-1"), {
        chart: {
            height: 320,
            type: "pie"
        },
    ...
    }).render(), new ApexCharts(document.querySelector("#pie-chart-2"), {
        chart: {
            height: 320,
            type: "donut"
        },
    ...
    }).render(), new ApexCharts(document.querySelector("#radialBar-chart-1"), {
        chart: {
            height: 350,
            type: "radialBar"
        },
    ...
    }, new ApexCharts(document.querySelector("#radialBar-chart-2"), e).render(), new ApexCharts(document.querySelector("#radar-chart-1"), {
        chart: {
            height: 350,
            type: "radar"
        },
    ...
    }).render(), (c = new ApexCharts(document.querySelector("#radar-chart-2"), {
        chart: {
            height: 350,
            type: "radar",
            dropShadow: {
