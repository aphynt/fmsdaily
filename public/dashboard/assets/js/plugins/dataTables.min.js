...
! function (n) {
    ...
    var C, U, t, e, $ = function (e, H) {
                ...
                if ("table" != this.nodeName.toLowerCase()) Z(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    var u = B.extend(!0, {}, $.models.oSettings, {
                        ...
                        f = (B.extend(!0, d, n.oLanguage), d.sUrl ? (B.ajax({
                            ...
                            url: d.sUrl,
                            success: function (e) {
                                z(t.oLanguage, e), B.extend(!0, d, e, u.oInit.oLanguage), ee(u, null, "i18n", [u]), Oe(u)
                            },
                            error: function () {
                        ...
                        for (g = T.length - 1; 0 <= g; g--) {
                            ...
                            for (Array.isArray(I) || (I = [I]), v = 0, b = I.length; v < b; v++) {
                                ...
                                if ("number" == typeof A && 0 <= A) {
                                    ...
                                    for (y = 0, D = C.length; y < D; y++) - 1 !== A.indexOf(":name") ? C[y].sName === A.replace(":name", "") && _(y, x) : M.forEach(function (e) {
                                        e = B(e[y].cell);
        ...
        P = function (e, t) {
            return s[t] || (s[t] = new RegExp(je(t), "g")), "string" == typeof e && "." !== t ? e.replace(/\./g, "").replace(s[t], ".") : e
        },
        h = function (e, t, n) {
            var a = [],
                r = 0,
    ...
    function ve(e, t, n, a) {
        ...
        if (null === c.nTr) {
            for (r = n || _.createElement("tr"), c.nTr = r, c.anCells = f, D(r, h), r._DT_RowIndex = t, be(e, c), l = 0, s = e.aoColumns.length; l < s; l++) {
                i = e.aoColumns[l], (o = (u = !n) ? _.createElement(i.sCellType) : a[l]) || Z(e, 0, "Incorrect column count", 18), o._DT_CellIndex = {
                    row: t,
                    column: l
                }, f.push(o);
                var p = me(e, t);
                !u && (!i.mRender && i.mData === l || B.isPlainObject(i.mData) && i.mData._ === l + ".display") || ue(o, p[l]), i.bVisible && !n ? r.appendChild(o) : !i.bVisible && n && o.parentNode.removeChild(o), i.fnCreatedCell && i.fnCreatedCell.call(e.oInstance, o, G(e, t, l), d, t, l)
            }
    ...
    function ye(e, t) {
        var n, a, r, o = e.oClasses,
            i = e.aoColumns,
            l = "header" === t ? e.nTHead : e.nTFoot,
            s = "header" === t ? "sTitle" : t;
        if (l) {
            if (0 === B("th, td", l).length && ("header" === t || h(e.aoColumns, s).join("")))
                for (r = B("<tr/>").appendTo(l), n = 0, a = i.length; n < a; n++) B("<th/>").html(i[n][s] || "").appendTo(r);
            var u = Ce(e, l, !0);
            "header" === t ? e.aoHeader = u : e.aoFooter = u, B(l).children("tr").attr("role", "row"), B(l).children("tr").children("th, td").each(function () {
                Qe(e, t)(e, B(this), o)
            })
        }
    }
    ...
    function Se(e) {
        var t = e.oLanguage,
            n = t.sZeroRecords,
            a = te(e);
        return e.iDraw <= 1 && ("ajax" === a || "ssp" === a) ? n = t.sLoadingRecords : t.sEmptyTable && 0 === e.fnRecordsTotal() && (n = t.sEmptyTable), B("<tr/>").append(B("<td />", {
            colSpan: H(e),
    ...
    function Te(e, t, n) {
        for (var a = {}, r = (B.each(t, function (e, t) {
                var n;
                null === t || (e = e.replace(/([A-Z])/g, " $1").split(" "), a[e[0]] || (a[e[0]] = {}), n = 1 === e.length ? "full" : e[1].toLowerCase(), e = a[e[0]], B.isPlainObject(t) ? t.contents ? e[n] = t : e[n] = {
            ...
            }), "bottom" === n && r.reverse(), []), i = 0, l = r.length; i < l; i++) r[i].val.full && (o.push({
            full: r[i].val.full
        }), we(e, o[o.length - 1]), delete r[i].val.full), Object.keys(r[i].val).length && (o.push(r[i].val), we(e, o[o.length - 1]));
        return o
    }
    ...
    function Ne(e, t, n, a, r) {
        if ("" !== n)
            for (var o = 0, i = "function" == typeof n ? n : null, l = n instanceof RegExp ? n : i ? null : function (e, t) {
                    ...
                    if (t.exact) return new RegExp("^" + je(e) + "$", t.caseInsensitive ? "i" : ""); {
                        var n, r, o;
    ...
    function Oe(n) {
        ...
        n.bInitialised ? (ye(n, "header"), ye(n, "footer"), xe(n, n.aoHeader), xe(n, n.aoFooter), _e(n), t = (e = n).nTHead, i = t.querySelectorAll("tr"), r = e.bSortCellsTop, o = ':not([data-dt-order="disable"]):not([data-dt-order="icon-only"])', !0 === r ? t = i[0] : !1 === r && (t = i[i.length - 1]), Ve(e, t, t === e.nTHead ? "tr" + o + " th" + o + ", tr" + o + " td" + o : "th" + o + ", td" + o), Be(e, r = [], e.aaSorting), e.aaSorting = r, Xe(n), w(n, !0), ee(n, null, "preInit", [n], !0), c(n), "ssp" != (i = te(n)) && ("ajax" == i ? Ie(n, {}, function (e) {
            var t = Ae(n, e);
    ...
    function Ve(l, e, t, n, s) {
        Je(e, t, function (o) {
            ...
            i.length && (w(l, !0), setTimeout(function () {
                for (var e, n, t = 0, a = i.length; t < a; t++) {
                    ...
                    ! function (e, t, n) {
                        ...
                        var r, o = e.aoColumns[t],
                            i = e.aaSorting,
                            l = o.asSorting;
                        o.bSortable && ("number" == typeof i[0] && (i = e.aaSorting = [i]), n && e.oFeatures.bSortMulti ? -1 !== (o = h(i, "0").indexOf(t)) ? null === (r = null === (r = a(i[o], !0)) && 1 === i.length ? 0 : r) ? i.splice(o, 1) : (i[o][1] = l[r], i[o]._idx = r) : (i.push([t, l[0], 0]), i[i.length - 1]._idx = 0) : i.length && i[0][0] == t ? (r = a(i[0]), i.length = 1, i[0][1] = l[r], i[0]._idx = r) : (i.length = 0, i.push([t, l[0]]), i[0]._idx = 0))
                    }(l, i[t], r)
                }
                Ue(l), e = l.aiDisplay, n = l.aiDisplayMaster, e.sort(function (e, t) {
    ...
    function $e(e) {
        ...
        if (l.bSort && l.bSortClasses) {
            for (t = 0, n = r.length; t < n; t++) a = r[t].src, B(h(e.aoData, "anCells", a)).removeClass(o + (t < 2 ? t + 1 : 3));
            for (t = 0, n = i.length; t < n; t++) a = i[t].src, B(h(e.aoData, "anCells", a)).addClass(o + (t < 2 ? t + 1 : 3))
        }
        e.aLastSort = i
    }
    ...
    function nt(r, o, e) {
        ...
        e && (t = new U(r)).one("draw", function () {
            e(t.ajax.json())
        }), "ssp" == te(r) ? c(r, o) : (w(r, !0), (n = r.jqXHR) && 4 !== n.readyState && n.abort(), Ie(r, {}, function (e) {
            he(r);
                ...
                if (r.off(t + " " + e + " " + a), h(l, "_details").length > 0) {
                    ...
                    r.on(e, function (e, t) {
                        ...
                        for (var r = 0, o = l.length; r < o; r++) {
                            n = l[r];
                            if (n._details) n._details.each(function () {
    ...
    function ut(t, n) {
        return function (e) {
            return y(e) || "string" != typeof e || (e = e.replace(d, " "), t && (e = I(e)), n && (e = R(e, !0))), e
        }
    }
    var ct = function (e, t) {
            var n, a = [],
        ...
        mt = (t(gt, function (e, t) {
            var n = this.context;
            return void 0 === e ? n.length && this.length ? n[0].aoData[this[0]]._details : void 0 : (!0 === e ? this.child.show() : !1 === e ? ht(this) : n.length && this.length && it(n[0], n[0].aoData[this[0]], e, t), this)
        ...
        gt = (t("columns()", function (n, a) {
            ...
            var e = this.iterator("table", function (e) {
                return t = n, l = a, s = (i = e).aoColumns, u = h(s, "sName"), c = h(s, "sTitle"), e = $.util.get("[].[].cell")(i.aoHeader), d = x(O([], e)), at("column", t, function (n) {
                    var a, e = g(n);
        ...
        }), $.version = "2.0.0", $.settings = [], $.models = {}, $.models.oSearch = {
            caseInsensitive: !0,
            search: "",
            regex: !1,
            smart: !0,
            ...
            oLanguage: {
                ...
                sInfo: "Menampilkan _START_ hingga _END_ dari _TOTAL_ _ENTRIES-TOTAL_",
                sInfoEmpty: "Menampilkan 0 hingga 0 dari 0 _ENTRIES-TOTAL_",
                sInfoFiltered: "(filtered from _MAX_ total _ENTRIES-MAX_)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
                sLengthMenu: "_MENU_ _ENTRIES_ per halaman",
                sLoadingRecords: "Data tidak ditemukan",
                sProcessing: "",
                sSearch: "Cari:",
                sSearchPlaceholder: "",
                sUrl: "",
    ...
    var i = $.ext.type,
        _t = ($.type = function (a, e, t) {
            ...
            t || (t = e, e = null), "className" === e ? n("className", t) : "detect" === e ? r(t) : "order" === e ? o(t) : "render" === e ? n("render", t) : "search" === e ? n("search", t) : e || (t.className && n("className", t.className), void 0 !== t.detect && r(t.detect), t.order && o(t.order), void 0 !== t.render && n("render", t.render), void 0 !== t.search && n("search", t.search))
        }, $.types = function () {
    ...
    function At(e, t, n) {
        var a = [],
            r = Math.floor(n / 2);
        return t <= n ? a = f(0, t) : 1 === n ? a = [e] : 3 === n ? e <= 1 ? a = [0, 1, "ellipsis"] : t - 2 <= e ? (a = f(t - 2, t)).unshift("ellipsis") : a = ["ellipsis", e, "ellipsis"] : e <= r ? (a = f(0, n - 2)).push("ellipsis", t - 1) : (t - 1 - r <= e ? a = f(t - (n - 2), t) : ((a = f(e - r + 2, e + r - 1)).push("ellipsis", t - 1), a)).unshift(0, "ellipsis"), a
    }
