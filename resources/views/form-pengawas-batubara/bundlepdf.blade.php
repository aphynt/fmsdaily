    ...
    <body>
        <table class="info-table">
            <tr>
                <td colspan="14"><img alt="Company Logo" height="40"
                    ...
                    alt="logo disini"  /></td>
                <td colspan="14"  style="text-align: right;"><b>FM-PRD-54/00/26/08/24</b></td>
            </tr>
        </table>
        <hr>
        ...
        <table class="info-table">
            <tr>
                ...
                <td colspan="9">: {{ $koleksi['dailyReport']->pic }}</td>
            </tr>
            <tr>
                <td colspan="5">Shift</td>
                <td colspan="9">: {{ $koleksi['dailyReport']->shift }}</td>
                <td colspan="5">NIK</td>
                <td colspan="9">: {{ $koleksi['dailyReport']->nik_pic }}</td>
            </tr>
            <tr>
        ...
        <table class="data_table">
            ...
            <tbody>
                @foreach ($koleksi['loadingPoint'] as $lp)
                <tr>
                ...
                @endforeach
                @if ($koleksi['loadingPoint']->isEmpty())
                    <tr>
        ...
        <table class="data_table">
            ...
            <tbody>
                @foreach ($koleksi['unitSupport'] as $sp)
                <tr>
                ...
                @endforeach
                @if ($koleksi['unitSupport']->isEmpty())
                    <tr>
                        <td style="padding-left:2px;"></td>
                        <td style="padding-left:2px;"></td>
                        <td style="padding-left:2px;"></td>
        ...
        <div class="grid-container" style="width: 100%; margin: 20px 0;">
            ...
            <div class="grid-table" style="float: left; width: 48%; margin-right: 2%;">
                <table>
                    <tbody>
                        @foreach ($koleksi['catatanPengawas'] as $cp)
                            <tr>
