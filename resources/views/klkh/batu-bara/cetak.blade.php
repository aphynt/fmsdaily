    ...
    <div class="container">
        ...
        <table style="width: 100%; text-align: center; border-spacing: 10px;">
            <tbody>
                ...
                <tr>
                    <td class="noborder nobg">@if ($bb->verified_foreman != null){!! $bb->verified_foreman !!}@endif</td>
                    <td class="noborder nobg">@if ($bb->verified_supervisor != null){!! $bb->verified_supervisor !!}@endif</td>
                    <td class="noborder nobg">@if ($bb->verified_superintendent != null){!! $bb->verified_superintendent !!}@endif</td>
                </tr>
                <tr>
