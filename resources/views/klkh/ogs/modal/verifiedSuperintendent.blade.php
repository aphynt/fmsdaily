<div class="modal fade" id="verifiedSuperintendent{{ $ogs->uuid }}" tabindex="-1" aria-labelledby="modalSupportLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('klkh.ogs.verified.superintendent', $ogs->uuid) }}" method="POST">
                @csrf
