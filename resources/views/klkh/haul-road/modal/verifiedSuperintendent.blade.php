<div class="modal fade" id="verifiedSuperintendent{{ $hr->uuid }}" tabindex="-1" aria-labelledby="modalSupportLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('klkh.haul-road.verified.superintendent', $hr->uuid) }}" method="POST">
                @csrf
