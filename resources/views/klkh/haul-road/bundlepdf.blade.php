            ...
            <tbody>
                ...
                <tr>
                    <td class="noborder nobg">
                        @if ($haulroad->verified_foreman != null)
                            <img src="{{ public_path('qr-temp/' . basename($haulroad->verified_foreman)) }}" style="max-width: 70px;">
                        @endif
                    </td>
                    <td class="noborder nobg">
                        @if ($haulroad->verified_supervisor != null)
                            <img src="{{ public_path('qr-temp/' . basename($haulroad->verified_supervisor)) }}" style="max-width: 70px;">
                        @endif
                    </td>
                    <td class="noborder nobg">
                        @if ($haulroad->verified_superintendent != null)
                            <img src="{{ public_path('qr-temp/' . basename($haulroad->verified_superintendent)) }}" style="max-width: 70px;">
                        @endif
                    </td>
                </tr>
                <tr>
