<div class="modal fade" id="verifiedSuperintendent{{ $dp->uuid }}" tabindex="-1" aria-labelledby="modalSupportLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('klkh.disposal.verified.superintendent', $dp->uuid) }}" method="POST">
                @csrf
