<div class="modal fade" id="verifiedAll{{ $dp->uuid }}" tabindex="-1" aria-labelledby="modalSupportLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('klkh.disposal.verified.all', $dp->uuid) }}" method="POST">
                @csrf
