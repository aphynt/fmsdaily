<div class="modal fade" id="verifiedSuperintendent{{ $ld->uuid }}" tabindex="-1" aria-labelledby="modalSupportLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('klkh.loading-point.verified.superintendent', $ld->uuid) }}" method="POST">
                @csrf
