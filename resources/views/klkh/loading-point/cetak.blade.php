    ...
    <div class="container">
        ...
        <table style="width: 100%; text-align: center; border-spacing: 10px;">
            <tbody>
                ...
                <tr>
                    <td class="noborder nobg">@if ($lp->verified_foreman != null){!! $lp->verified_foreman !!}@endif</td>
                    <td class="noborder nobg">@if ($lp->verified_supervisor != null){!! $lp->verified_supervisor !!}@endif</td>
                    <td class="noborder nobg">@if ($lp->verified_superintendent != null){!! $lp->verified_superintendent !!}@endif</td>
                </tr>
                <tr>
