<div class="modal fade" id="verifiedSuperintendent{{ $lpr->uuid }}" tabindex="-1" aria-labelledby="modalSupportLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('klkh.lumpur.verified.superintendent', $lpr->uuid) }}" method="POST">
                @csrf
