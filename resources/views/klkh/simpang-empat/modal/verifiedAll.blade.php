<div class="modal fade" id="verifiedAll{{ $se->uuid }}" tabindex="-1" aria-labelledby="modalSupportLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('klkh.simpangempat.verified.all', $se->uuid) }}" method="POST">
                @csrf
