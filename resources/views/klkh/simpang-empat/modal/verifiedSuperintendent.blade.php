<div class="modal fade" id="verifiedSuperintendent{{ $se->uuid }}" tabindex="-1" aria-labelledby="modalSupportLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('klkh.simpangempat.verified.superintendent', $se->uuid) }}" method="POST">
                @csrf
