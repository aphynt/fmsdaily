@include('layout.head', ['title' => 'Catatan Pengawas Batu Bara'])
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Laporan Harian Pengawas (Catatan Pengawas Batu Bara)</a></li>
                        </ul>
                    </div>
                    <div class="col-12">
