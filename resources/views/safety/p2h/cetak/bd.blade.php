...
<body>
    <div class="header">
        ...
        <h5 style="text-align: center;">FM-SHE-31/06/08/05/25</h5>
    </div>
    ...
    <table>
        <tr style="border-top:1px solid #000; border-right:1px solid #000">
            ...
            <td style="border:none" colspan="6">: BULLDOZER</td>
            <td rowspan="2" colspan="2"><h3>B/D</h3></td>
        </tr>
    ...
    <div class="container">
        <p>
            <ol style="display:flex;">
                ...
                <div class="dua" style="font-style: italic">
                    <li>O =  Operator</li>
