            ...
            <div class="page-block">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-2 mb-2 d-flex align-items-end">
                        <a href="{{ asset('sop/coal_getting.pdf') }}" class="btn btn-primary w-100" style="padding-top:10px;padding-bottom:10px;">Download</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    function reloadAndLoadIframe() {
        ...
        if (!sessionStorage.getItem('iframeLoaded')) {
            ...
            document.getElementById('myIframe').src = 'https://docs.google.com/gview?url={{ asset('sop/coal_getting.pdf') }}&embedded=true';
        }
    }
